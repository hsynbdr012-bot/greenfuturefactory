document.addEventListener('DOMContentLoaded', () => {
    ...
    if (trackBtn && orderInput) {
        trackBtn.addEventListener('click', () => {
            ...
            if (data) {
                resultDiv.innerHTML = `
                    <div style="background: #fff; padding: 20px; border-radius: 10px; border-right: 5px solid ${data.color}; box-shadow: 0 4px 6px rgba(0,0,0,0.1); text-align: right;">
                ...
                resultDiv.innerHTML = `<p style="color: #e74c3c; text-align: center;">❌ عذراً، لم يتم العثور على طلب بهذا الاسم أو الرقم.</p>`;
            }
        });
    }
});
